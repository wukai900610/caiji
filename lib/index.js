...
function creditSupplyTable(connection,tableName) {
    ...
    sql = 'CREATE TABLE IF NOT EXISTS `'+tableName+'` (`id` int(10) NOT NULL,`companyName` varchar(300) COLLATE utf8mb4_unicode_ci NOT NULL,`baseInfo` text COLLATE utf8mb4_unicode_ci,`img` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,`otherContent` text COLLATE utf8mb4_unicode_ci,`productsUrl` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,`connectUrl` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;'
    connection.query(sql, function(err, result) {
        if (err) {
            console.log(err);
            return;
